...
def calendar(dark: bool, days: list[dict]) -> str:
    ...
    parts = [f'<svg xmlns="http://www.w3.org/2000/svg" width="840" height="315" viewBox="0 0 840 315" role="img" aria-label="Isometric calendar of GitHub contributions from {start} to {end}">',
             f'<rect x="1" y="1" width="838" height="313" rx="15" fill="{bg}" stroke="{edge}"/>',
